package by.it.makstra.lesson03;
...
public class A_Huffman {
    ...
    String encode(File file) throws FileNotFoundException {
        Scanner scanner = new Scanner(file);//прочитаем строку для кодирования из тестового файла
        ...
        {
            priorityQueue.add(new LeafNode(me.getValue(),me.getKey()));
        }
