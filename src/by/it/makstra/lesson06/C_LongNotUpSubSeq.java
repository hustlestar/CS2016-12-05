...
public class C_LongNotUpSubSeq {
    ...
    int getNotUpSeqSize(InputStream stream) throws FileNotFoundException {
        ...
        int[] prev = new int[n]; //массив индексов элементов, указывающих из какой ячейки мы пришли в текущую
        ...
        int[] L = new int[result]; //массив ответов(идексов подпоследовательности)
