...
public class A_BinaryFind {
    ...
    int findTheValue(int lowEnd, int hiEnd, int value, int[] a) {
        ...
        while (true) {
            ...
            if (a[catcher] > value) {
                ...
                /*a[catcher] == value ? return catcher :
                lowEnd >= hiEnd ? return -1:
                a[catcher] > value ? hiEnd = catcher - 1:
                lowEnd = catcher + 1;*/
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        InputStream stream = new FileInputStream(root + "by/it/vadimsquorpikkor/lesson04/dataA.txt");
