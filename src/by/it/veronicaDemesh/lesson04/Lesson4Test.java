...
public class Lesson4Test {
    ...
    public void A() throws Exception {
        ...
        InputStream stream = new FileInputStream(root + "by/it/veronicaDemesh/lesson04/dataA.txt");
    ...
    public void C() throws Exception {
        String root = System.getProperty("user.dir") + "/src/";
        InputStream stream = new FileInputStream(root + "by/it/veronicaDemesh/lesson04/dataC.txt");
