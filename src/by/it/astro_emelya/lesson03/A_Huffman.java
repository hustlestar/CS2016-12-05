package by.it.astro_emelya.lesson03;
...
public class A_Huffman {
    ...
    String encode(File file) throws FileNotFoundException {
        ...
        for (Map.Entry<Character, Integer> map : count.entrySet()) {
            LeafNode leafNode = new LeafNode(map.getValue(), map.getKey());
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        File f = new File(root + "by/it/astro_emelya/lesson03/dataHuffman.txt");
