package by.it.rudkouski.lesson03;
...
public class A_Huffman {
    ...
    String encode(File file) throws FileNotFoundException {
        ...
        for (Map.Entry<Character, Integer> map : count.entrySet()) {
            LeafNode leaf = new LeafNode(map.getValue(), map.getKey());
        ...
        while (priorityQueue.size() > 1) {
            Node childLeft = priorityQueue.remove();
            Node childRight = priorityQueue.remove();
