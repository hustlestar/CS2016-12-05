...
public class A_Huffman {
    ...
    String encode(File file) throws FileNotFoundException {
        ...
        for (Map.Entry<Character, Integer> entry : count.entrySet()) {
            ...
            priorityQueue.add(new LeafNode(freq, ch));
        }
        ...
        while(priorityQueue.size() > 1){
            ...
            InternalNode nodePar = new InternalNode(nodeLeft, nodeRight);
            priorityQueue.add(nodePar);
        }


        InternalNode node3 = (InternalNode) priorityQueue.peek();
        node3.fillCodes("");
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        File f = new File(root + "by/it/alesnax/lesson03/dataHuffman.txt");
